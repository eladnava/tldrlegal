var table = require('legally/lib/table');
var obligationInfo = require('../metadata/obligationInfo');

module.exports = function (results, unknownLicenses) {
...
function outputSummary(results) {
    ...
    table(rows, { Obligation: 35, Packages: 20 }, { title: 'License Obligation Summary' });
}
